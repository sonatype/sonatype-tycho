package org.eclipse.tycho.osgitools.targetplatform;
    ...
    implements TargetPlatformResolver
{
                                           ...
                                           List<ReactorProject> reactorProjects, List<Dependency> dependencies )
    {
        ...
        for ( File site : layout.getSites() )
        {
            ...
            for ( File feature : layout.getFeatures( site ) )
            {
                ...
                ArtifactKey key =
                    new DefaultArtifactKey( org.eclipse.tycho.ArtifactKey.TYPE_ECLIPSE_FEATURE, desc.getId(),
                                            desc.getVersion() );
    ...
    public ArtifactKey getArtifactKey( MavenSession session, MavenProject project )
    {
        ...
        ArtifactKey key =
            new DefaultArtifactKey( org.eclipse.tycho.ArtifactKey.TYPE_ECLIPSE_PLUGIN, id[0].getValue(),
                                    version[0].getValue() );
        return key;
    }
