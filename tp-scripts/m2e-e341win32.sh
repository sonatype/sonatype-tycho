DIR=.
TPDIR=$DIR/eclipse-tp-e341win32
rm -rf $TPDIR/eclipse
mkdir -p $TPDIR
...
# wtp&co 3.0 GA
#wget -P $TPDIR/features  -N http://download.eclipse.org/modeling/emf/emf/downloads/drops/2.4.0/R200806091234/emf-runtime-2.4.0.zip
#wget -P $TPDIR/features  -N http://download.eclipse.org/modeling/emf/emf/downloads/drops/2.4.0/R200806091234/xsd-runtime-2.4.0.zip
#wget -P $TPDIR/features  -N http://download.eclipse.org/tools/gef/downloads/drops/3.4.0/R200806091334/GEF-SDK-3.4.0.zip
#wget -P $TPDIR/features  -N http://download.eclipse.org/datatools/downloads/1.6/dtp-sdk_1.6.0.zip
#wget -P $TPDIR/features  -N http://download.eclipse.org/webtools/downloads/drops/R3.0/R-3.0-20080616152118/wtp-sdk-R-3.0-20080616152118a.zip
#wget -P $TPDIR/features   -N http://download.eclipse.org/modeling/emf/emf/downloads/drops/2.4.1/R200808251517/emf-runtime-2.4.1.zip
#wget -P $TPDIR/features   -N http://download.eclipse.org/modeling/emf/emf/downloads/drops/2.4.1/R200808251517/xsd-runtime-2.4.1.zip
#wget -P $TPDIR/features   -N http://download.eclipse.org/tools/gef/downloads/drops/3.4.1/R200809101400/GEF-SDK-3.4.1.zip
wget -P $TPDIR/features   -N http://download.eclipse.org/datatools/downloads/1.6/dtp-sdk_1.6.1.zip
wget -P $TPDIR/features   -N http://download.eclipse.org/webtools/downloads/drops/R3.0/R-3.0.3-20081113203138/wtp-sdk-R-3.0.3-20081113203138.zip

# emf 2.4.1
wget -P $TPDIR/features   -N http://download.eclipse.org/modeling/emf/emf/downloads/drops/2.4.1/R200808251517/emf-sdo-xsd-SDK-2.4.1.zip

# zest 3.4 GA
#wget -P $TPDIR/features  -N http://download.eclipse.org/tools/gef/downloads/drops/3.4.0/R200806091334/GEF-zest-sdk-3.4.0.zip
wget -P $TPDIR/features  -N http://download.eclipse.org/tools/gef/downloads/drops/3.4.1/R200809101400/GEF-ALL-3.4.1.zip
...
unzip $FILES/eclipse-SDK-3.4.1-win32.zip
