package org.sonatype.tycho.test.TYCHO502sourceBundleQualifier;
...
public class Tycho502SourceBundleQualifierTest
    extends AbstractTychoIntegrationTest
{

    @Test
    public void testReferencedQualifierInSourceBundle()
        throws Exception
    {
    ...
    private String getQualifierReferencedBySourceBundle( File targetDir )
        throws IOException
    {
    ...
    private String getBundleQualifier( File targetDir )
        throws IOException
    {
    ...
    private String getManifestHeaderValue( String key, File bundleJar )
        throws IOException
    {
