...
import static org.sonatype.tycho.test.util.EnvironmentUtil.getTargetPlatforn;
...
public class UpdateSiteUtil {
	...
	public static int mirrorSite(File site, File detination) throws Exception {
		...
		try {
			...
			String[] parameters = { "-cp", startupJar.getAbsolutePath(),
					"org.eclipse.core.launcher.Main", "-application",
					"org.eclipse.update.core.standaloneUpdate", "-command",
					"mirror", "-from", siteUrl, "-to",
					detination.getAbsolutePath() };
