package org.sonatype.tycho.test.TYCHO0164tycho03RepositoryRoundtrip;
...
public class Tycho03RepositoryRoundtripTest extends AbstractTychoIntegrationTest {

	@Test
	public void testLocalMavenRepository() throws Exception {
        Verifier v01 = getVerifier("TYCHO0164tycho03RepositoryRoundtrip/build01", false);
    	v01.getCliOptions().add( "-DtargetPlatform=" + getTargetPlatforn() );
        v01.executeGoal("install");
        v01.verifyErrorFreeLog();

        Verifier v02 = getVerifier("TYCHO0164tycho03RepositoryRoundtrip/build02", false);
