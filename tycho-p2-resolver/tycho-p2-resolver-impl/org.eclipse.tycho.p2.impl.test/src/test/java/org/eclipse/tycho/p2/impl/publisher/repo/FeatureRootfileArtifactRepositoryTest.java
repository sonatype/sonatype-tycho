...
public class FeatureRootfileArtifactRepositoryTest
{
        ...
        throws Exception
    {
        ...
        IArtifactDescriptor artifactDescriptor =
            createArtifactDescriptor( PublisherHelper.BINARY_ARTIFACT_CLASSIFIER, "org.eclipse.tycho.test.p2" );
        ...
        throws Exception
    {
        ...
        IArtifactDescriptor artifactDescriptor =
            createArtifactDescriptor( "non-binary-classifier", "org.eclipse.tycho.test.p2" );
        subject.getOutputStream( artifactDescriptor ).close();
