...
public class FeatureRootAdviceTest
{
    ...
    @Test
    public void testDescriptorIsNullIfNoRootFiles()
        throws Exception
    {
    ...
    @Test( expected = IllegalArgumentException.class )
    public void testGlobalPermissionsChmodMissing()
        throws Exception
    {
        Properties buildProperties = createBuildPropertiesWithDefaultRootFiles();
    ...
    @Test( expected = IllegalArgumentException.class )
    public void testSpecificPermissionsChmodMissing()
        throws Exception
    {
        Properties buildProperties = createBuildPropertiesWithDefaultRootFiles();
    ...
    @Test( expected = IllegalArgumentException.class )
    public void testGlobalPermissionsButNoFiles()
        throws Exception
    {
        Properties buildProperties = createBuildPropertiesWithoutRootKeys();
    ...
    @Test( expected = IllegalArgumentException.class )
    public void testSpecificPermissionsButNoFiles()
        throws Exception
    {
        Properties buildProperties = createBuildPropertiesWithDefaultRootFiles();
    ...
    @Ignore
    @Test( expected = IllegalArgumentException.class )
    public void testPermissionsChmodInvalidValue()
        throws Exception
    {
        Properties buildProperties = createBuildPropertiesWithDefaultRootFiles();
    ...
    private static class PermissionEntryComparator
