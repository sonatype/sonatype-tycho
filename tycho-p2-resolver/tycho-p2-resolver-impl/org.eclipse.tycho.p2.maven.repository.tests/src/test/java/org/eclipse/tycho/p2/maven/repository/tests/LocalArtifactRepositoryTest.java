...
public class LocalArtifactRepositoryTest
{
    ...
    public void getP2Location()
    {
        ...
        Assert.assertEquals( new File( basedir, "p2/osgi/bundle/org.eclipse.tycho.test.p2/1.0.0/org.eclipse.tycho.test.p2-1.0.0.jar" ).toURI(), location );
        ...
        Assert.assertEquals( new File( basedir, "p2/osgi/bundle/org.eclipse.tycho.test.p2/1.0.0/org.eclipse.tycho.test.p2-1.0.0-pack200.jar.pack.gz" ).toURI(),
                             location );
    }
    ...
    {
        ArtifactKey key =
            new ArtifactKey( PublisherHelper.OSGI_BUNDLE_CLASSIFIER, "org.eclipse.tycho.test."
    ...
    public void getMavenLocation()
    {
        ...
        Assert.assertEquals( new File( basedir,
                                       "group/org.eclipse.tycho.test.maven/1.0.0/org.eclipse.tycho.test.maven-1.0.0.jar" ).toURI(),
                             location );
    }
    ...
    public void getMavenLocationWithClassifierAndExtension()
    {
        ...
        Assert.assertEquals( new File( basedir,
                                       "group/org.eclipse.tycho.test.maven/1.0.0/org.eclipse.tycho.test.maven-1.0.0-classifier.value.jar" ).toURI(),
                             repo.getLocation( desc ) );

        desc.setProperty( RepositoryLayoutHelper.PROP_EXTENSION, "zip" );
        Assert.assertEquals( new File( basedir,
                                       "group/org.eclipse.tycho.test.maven/1.0.0/org.eclipse.tycho.test.maven-1.0.0-classifier.value.zip" ).toURI(),
                             repo.getLocation( desc ) );

        desc.setProperty( RepositoryLayoutHelper.PROP_CLASSIFIER, null );
        Assert.assertEquals( new File( basedir,
                                       "group/org.eclipse.tycho.test.maven/1.0.0/org.eclipse.tycho.test.maven-1.0.0.zip" ).toURI(),
                             repo.getLocation( desc ) );
    }
