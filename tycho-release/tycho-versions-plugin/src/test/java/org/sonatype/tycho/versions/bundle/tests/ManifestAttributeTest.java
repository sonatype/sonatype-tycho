...
public class ManifestAttributeTest
{
    ...
    public void shouldAddLine()
    {
        ...
        // then
        assertEquals( "headervalue1headervalue2headervalue3",
                attribute.getValue() );
    ...
    public void shouldGetValue() throws Exception
    {
        ...
        ManifestAttribute attribute2 = new ManifestAttribute( name + ": "
                + valuelong );
        ManifestAttribute attribute3 = new ManifestAttribute( name
                + ": abcdefghijklmnopq" );
