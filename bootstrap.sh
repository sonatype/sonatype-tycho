...
$TYCHO_M2_HOME/bin/mvn clean install -e -V -Pbootstrap-1 ${MAVEN_PARAMS} || exit

$TYCHO_M2_HOME/bin/mvn clean install -e -V -Pbootstrap-2 -Dtycho.targetPlatform=$TYCHO_TARGET_PLATFORM ${MAVEN_PARAMS} || exit
